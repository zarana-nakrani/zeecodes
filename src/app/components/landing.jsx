      ...
      <div className="grid lg:grid-cols-2 flex-col columns-2 lg:gap-5 gap-10 justify-between h-full">
        <div className="flex flex-row ">
          <Image
            ...
            height="100"
            width="100"
            className="h-100 w-60 col-start-1.5 border-none rounded-lg md:h-130 md:w-80"
          />
          <div
            className="
            w-50
          ...
          >
            <Link
              ...
              className="absolute translateabsolute top-[0%] left-[52%] md:top-[4%] md:left-[55%] text-4xl md:text-5xl text-gray-500 hover:scale-110 transition-transform bg-black m-0"
            >
              <FaGithub />
            </Link>
            <Link
              href="https://www.linkedin.com/in/zarana-nakrani"
              className="absolute translateabsolute top-[23%] md:top-[30%] left-[80%] md:left-[85%] text-3xl md:text-4xl text-gray-500 hover:scale-110 border rounded-full transition-transform z-10 p-3 bg-black"
            >
              <SiLeetcode />
            </Link>
            <Link
              href="https://github.com/zarana-nakrani"
              className="absolute translateabsolute top-[55%] md:top-[60%] left-[80%] md:left-[85%] text-3xl md:text-4xl text-gray-500 hover:scale-110  border rounded-full transition-transform z-10 p-3 bg-black"
            >
              <FaMediumM />
            </Link>
            <Link
        ...
        <div className="flex flex-col font-mono gap-5 my-auto">
          <h1 className="text-3xl md:text-5xl text-green-400">
            {'<'}Zarana Nakrani{'/>'}
          </h1>
          ...
          <Button asChild className="w-50 mt-3">
